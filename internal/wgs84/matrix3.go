...
// Mat3 is a 3x3 matrix stored row-major. It is used for the ENU rotation
// and for the covariance rotation that converts ECEF dilution values into
// local East/North/Up components.
type Mat3 struct {
	M00, M01, M02 float64
	M10, M11, M12 float64
	M20, M21, M22 float64
...
// EqualWithin compares every entry with an absolute tolerance.
